...
- [ ] One palette, in `themes/<name>.toml`, where `<name>` matches `meta.name`
...
- [ ] `meta.ansi_source` names the real base scheme; its license:
- [ ] Color values only — no images or any other asset
- [ ] `mise run ci` passes
