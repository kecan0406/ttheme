...
export const iterm2: Emitter = {
  id: "iterm2",
  limits:
    "colors only — font lives in the profile; ignores OSC 12, so the cursor keeps its profile color at runtime",
