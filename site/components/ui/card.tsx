...
function CardTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('font-display text-display-sm font-black [overflow-wrap:anywhere]', className)}
      {...props}
    />
  )
}
...
function CardDescription({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('col-span-full font-mono text-xs text-muted-foreground [overflow-wrap:anywhere]', className)}
      {...props}
    />
  )
}
...
function CardContent({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="card-content" className={cn('px-4.5', className)} {...props} />
}

function CardFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div data-slot="card-footer" className={cn('flex items-center border-t px-4.5 py-3.5', className)} {...props} />
  )
}
